...
bool robot_msgs__msg__imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_msgs.msg._imu.IMU", full_classname_dest, 23) == 0);
  }
  robot_msgs__msg__IMU * ros_message = _ros_message;
  {  // quaternion
...
PyObject * robot_msgs__msg__imu__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_msgs.msg._imu");
