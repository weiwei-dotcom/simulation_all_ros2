...
class RobotCommand(metaclass=Metaclass_RobotCommand):
    ...
    _fields_and_field_types = {
        'motor_command': 'robot_msgs/MotorCommand[32]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['robot_msgs', 'msg'], 'MotorCommand'), 32),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robot_msgs.msg import MotorCommand
        self.motor_command = kwargs.get(
            'motor_command',
            [MotorCommand() for x in range(32)]
        )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_command' field must be a set or sequence with length 32 and each value of type 'MotorCommand'"
