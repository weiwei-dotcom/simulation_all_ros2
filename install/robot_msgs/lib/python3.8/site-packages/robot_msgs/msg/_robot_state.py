...
class RobotState(metaclass=Metaclass_RobotState):
    ...
    _fields_and_field_types = {
        'imu': 'robot_msgs/IMU',
        'motor_state': 'robot_msgs/MotorState[32]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['robot_msgs', 'msg'], 'IMU'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['robot_msgs', 'msg'], 'MotorState'), 32),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'motor_state' field must be a set or sequence with length 32 and each value of type 'MotorState'"
